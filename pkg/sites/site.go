...
// A StaticSite is a single repo/branch/etc that will be served on a given hostname by the manager.
...
// The close channel for the sync loop
...
// Returns the subset of fields that are ok for public consumption (API)
...
// Validates user provided fields for a StaticSite
...
// Performs a refresh of the repo
func (sd *StaticSite) Update() error {
